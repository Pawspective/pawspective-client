...
Rectangle {
    ...
    readonly property int maxPostLength: 2000
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            ColumnLayout {
                ...
                Text {
                    text: (viewModel ? viewModel.text.length : 0) + " / " + maxPostLength + " characters"
                    font.family: theme.fontName
                    font.pixelSize: root.fieldLabelFontSize
                    color: (viewModel && viewModel.text.length > maxPostLength) ? theme.errorColor : theme.textDark
            ...
            ColumnLayout {
                ...
                PhotoUploader {
                    ...
                    onUploadCompleted: function(fileName) {
                        createPostViewModel.addPhoto(fileName)
                    }
                }
            }
            ...
            ColumnLayout {
                ...
                CustomButton {
                    text: viewModel && viewModel.isBusy ? "Creating..." : "Create Post"
